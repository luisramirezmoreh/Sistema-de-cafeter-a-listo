...
import { ShoppingCart, Plus, Minus, Trash2, Settings, Coffee, TrendingUp, Sparkles, Gift } from 'lucide-react';
            ...
            {sortedCategories.map(category => {
              ...
              return (
                <div key={category}>
                  ...
                  {/* Botones de Mejoras de Servicio debajo de Capuchinos */}
                  {category === 'capuchinos' && (
                    <div className="mt-6 space-y-4">
                      <h3 className="text-base md:text-lg font-bold text-amber-700 mb-3">☕ Mejoras de Servicio</h3>
                      <div className="grid grid-cols-2 gap-3 md:gap-4">
                        <Button
                          onClick={() => setShowCreateUpgradeModal(true)}
                          className="bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 text-white w-full h-16 md:h-20 text-base md:text-lg font-semibold"
                          size="lg"
                        >
                        ...
                        <Button
                          ...
                          className="bg-gradient-to-r from-purple-500 to-indigo-500 hover:from-purple-600 hover:to-indigo-600 text-white w-full h-16 md:h-20 text-base md:text-lg font-semibold disabled:opacity-50"
                          size="lg"
                        >
                      ...
                      {activeUpgrades.length > 0 && (
                        <div className="mt-4 space-y-2">
                          <p className="text-sm md:text-base font-semibold text-gray-600">Mejoras Activas:</p>
                          {activeUpgrades.map(upgrade => (
                            <Card key={upgrade.id} className="p-3 md:p-4 bg-gradient-to-r from-purple-50 to-indigo-50 border-2 border-purple-300">
